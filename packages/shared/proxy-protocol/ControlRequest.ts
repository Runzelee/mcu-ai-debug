...
export type ControlRequest = { "method": "initialize", "params": { 
/**
 ...
 */
version: string, } } | { "method": "AllocatePorts", "params": { 
/**
 * Number of consecutive ports needed 
 */
ports_spec: PortAllocatorSpec, } } | { "method": "StartGdbServer", "params": { 
/**
 ...
 */
server_regexes: Array<string>, } } | { "method": "streamStatus", "params": { stream_id: number, } } | { "method": "heartbeat" };
